...
export function Iphone({
  ...
  return (
    <div
      ...
      {...props}
    >
      {/* Screen content layer — media or children */}
      {hasVideo && (
        <div
      ...
      {/* Children rendered inside the screen area */}
      ...
      {/* Phone SVG shell — always on top via z-20 so it overlaps screen content edges */}
      <svg
